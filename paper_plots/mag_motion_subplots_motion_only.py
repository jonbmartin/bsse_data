...
m_v_stop = get_3d_motion(a, b, bs_off)
...
m_v_multiphoton = get_3d_motion(a, b, bs_off)
...
ax1.set_title(u'|$b_{bs}(t) + b_{ex}(t)$|')
ax1.set_ylabel('a.u.')
ax1.set_xlabel('t (ms)')
...
ax2.set_title(r'$B_1^+$=0.17 mT (stopband)')
ax2.set_title(r'Simulated profile, PBC 0.14mT $\rightarrow$ 0.11mT')
ax2.set_xlim3d(-1, 1)
ax2.set_ylim3d(-1, 1)
ax2.set_zlim3d(-1, 1)
...
ax3.set_title(r'$B_1^+$=0.14 mT (passband)')
ax3.set_xlim3d(-1, 1)
ax3.set_ylim3d(-1, 1)
ax3.set_zlim3d(-1, 1)

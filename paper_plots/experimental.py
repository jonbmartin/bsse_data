...
# shifting plots
axs[0,0].set_title('Simulated Excitation')
axs[0,1].set_title('Experimental')
axs[1,0].set_ylabel(r'$|M_{xy}|/M_0$')
axs[1,1].set_ylabel(r'signal (a.u.)')
axs[2,0].set_xlabel(r'$B_1 (G)$')
axs[2,1].set_xlabel(r'$B_1 (G)$')



axs[2,0].plot(b1_ax.T,abs(Mxybase.T))
axs[2,0].plot(b1_ax.T,abs(Mxyshift.T))
...
axs[1,0].plot(b1_ax.T,abs(Mxytb.T),'r')
...
# FA plots
axs[0,0].plot(b1_ax.T,abs(Mxybase.T))
axs[0,0].plot(b1_ax.T,abs(Mxyfa.T),'g')
...
plt.savefig('figures_out/experimental.png',dpi=300)
